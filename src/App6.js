...
import "./App.css";
import Person from "./Person/Person6";
    ...
    return (
      <div className="App">
       ...
       <p>ma première appli!</p>
        {/* <button onClick={this.switchNameHandler.bind(this, 'Voltaire')}>Changer de nom</button> // */} //Préconiser Bind car la fonction peut engendrer de render en série non contrôlés
